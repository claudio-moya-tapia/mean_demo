 ...
 */
function AdminSliderController() {
    //this.auth = ['index', 'list', 'view', 'new', 'edit', 'delete'];
    this.auth = [];
}

AdminSliderController.prototype.list = function() {
...
AdminSliderController.prototype.new = function() {
...
AdminSliderController.prototype.edit = function() {
...
AdminSliderController.prototype.delete = function() {
 ...
 * Module exports
 */
module.exports = new AdminSliderController();